# Esta es la GUI del proyecto, aquí se crea y se puede modificar.
# Usé TKinter para hacerla, hay programas más sencillos de usar para crear GUis, 
# pero consideré mejor hacerla "a manita" para que sea más fácil modificar cada parámetro 
...
# Esta función crea toda la interfaz, el orden en que está formada la GUI es de arriba para abajo, comenzando desde la izquierda
def Crear_Interfaz():
...
#    """
# Esto se usa para mostrar la captura dentro de la GUI, No se usa en el futuro, solo es para poder mostrarla en ese espacio
# La captura real se almacena antes de hacer esto y se manda esta para procesar.
...
#"""
    ...
    Label_Joint1_Value.place(x= 500,y=150)
    ...
    Label_Joint3_Value.place(x= 500,y=250)
    ...
    Boton_MandarRobot = tk.Button(window,text ="Mandar a Robot",font=("Arial",13))
