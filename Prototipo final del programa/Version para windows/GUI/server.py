# Este es el servidor TCP/IP, es una modificación del encontrado en la carpeta de programaciones independientes.
...
class ServerSocket:
    # Se inicia el protocolo ejecutando algunas funciones
    ...
    def receiveImages(self):
        ...
        try:
            while True:
                # Se reciben las imágenes y se procesan para reconocer el texto en cada una, posteriormente se envian de regreso al servidor
